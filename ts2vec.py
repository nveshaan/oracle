...
class TS2Vec:
    ...
    def encode(self, data, mask=None, encoding_window=None, causal=False, sliding_length=None, sliding_padding=0):
        ...
        Args:
            data (torch.Tensor or numpy.ndarray): This should have a shape of (n_instance, n_timestamps, n_features). All missing data should be set to NaN.
        ...
        Returns:
            repr: The representations for data (torch.Tensor).
        '''
        ...
        with torch.no_grad():
            ...
            if sliding_length is not None:
                ...
                output = self._eval_with_pooling(data, mask, encoding_window=encoding_window)
                if encoding_window == 'full_series':
